...
setup() {
    ...
    export TEST_SCRIPT_DIR="${TEST_TMP_DIR}/wordpress-open"
    mkdir -p "${TEST_SCRIPT_DIR}"
    
    cp "${BATS_TEST_DIRNAME}/../../../../env-adapters/wordpress/open.cmd" "${TEST_SCRIPT_DIR}/open.cmd"
...
EOF
    ...
    # Mock ssh returning wp-config defines for util
...
@test "Wordpress Open: Shell Remote" {
    export ENV_SOURCE="dev"
    export ENV_SOURCE_HOST="example.com"
    export ENV_SOURCE_PORT="22"
    export ENV_SOURCE_USER="user"
