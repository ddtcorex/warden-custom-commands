...
if [[ -n "${DRY_RUN:-}" ]]; then
    ...
    printf "  1. composer require laravel/framework:^%s --no-update\n" "${TARGET_VERSION}"
    printf "  2. composer update\n"
    printf "  3. php artisan migrate (if applicable)\n"
    exit 0
fi
...
printf "\n"
printf "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
printf "✅ Laravel upgrade to %s completed!\n" "${TARGET_VERSION}"
printf "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
printf "\n"
